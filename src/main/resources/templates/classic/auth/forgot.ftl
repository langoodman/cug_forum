                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="submitForm" method="POST" action="${base}/forgot" accept-charset="UTF-8">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" type="button" id="sendCode" style="background-color: #2662a9;">获取验证码</button>
                                    </span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary btn-block" style="background-color: #2662a9;">
                                提 交
                            </button>
                        </form>
                    </div>
