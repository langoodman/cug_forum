                    ...
                    <li class="list-group-item">
                        <div class="text-center">
                            <a class="btn btn-default btn-sm" href="javascript:void(0);" data-id="${view.id}" rel="favor">
                                <i class="icon icon-star"></i> <span id="flag">收藏</span> <strong id="favors">${view.favors}</strong>
                            </a>

                            <a class="btn btn-default btn-sm" href="javascript:void(0);" data-id="${view.id}" rel="unfavor">
                                取消收藏
                            </a>
                        </div>
                    </li>
